          ...
          {selectedPlanMeta && (
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-slate-600">
                  Je vraagt nu het pakket <strong>{selectedPlanMeta.name}</strong> aan.
                </p>
              </div>
              ...
              <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700">
                      ...
                      {selectedPlanMeta.monthlyLimit ? ` — ${selectedPlanMeta.monthlyLimit} credits` : ' — op aanvraag'}
                    </div>
                  </div>
                </div>
                ...
                {selectedPlanMeta.key !== 'custom' && (
                  <div className="rounded-lg border border-slate-200 bg-white p-3 text-sm text-slate-700">
                    <p className="font-medium text-slate-900">Prijsindicatie</p>
                    {billingCycle === 'monthly' ? (
                      <p className="mt-1">
                        {formatEuro(selectedPlanMeta.monthlyPriceExVat || 0)} per maand <strong>excl. btw</strong>
                      </p>
                    ) : (
                      <p className="mt-1">
                        {formatEuro(selectedPlanMeta.yearlyPriceExVat || 0)} per jaar <strong>excl. btw</strong>
                      </p>
                    )}
                  </div>
                )}
